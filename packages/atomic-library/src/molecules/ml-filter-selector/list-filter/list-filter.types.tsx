...
export type ListFilterType = Omit<
...
export type ListFilterWrapperProps = ListFilterWrapperConfiguration &
  IndexFilterHandler;

export type ListFilterProps = ListFilterType & {
  onClick: (element: ListOption) => void;
};
