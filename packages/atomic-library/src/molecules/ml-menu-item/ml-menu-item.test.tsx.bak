...
describe('molecule/ml-menu-item', () => {
  ...
  describe('when a user clicks the menu item', () => {
    it('should call onClick when menu item is clicked', () => {
      const { getByTestId } = render(<MlMenuItem {...defaultProps} isLink={false} />)
  ...
  describe('when the menu item is not open', () => {
    it('should have the value of aria-expanded equal to false', () => {
      const { getByTestId } = render(<MlMenuItem {...defaultProps} isLink={false} showIcon={true} />)
      expect(getByTestId(menuItemTestId)).toHaveAttribute('aria-expanded', 'false')
    })
  })

  describe('when the menu item is open', () => {
    it('should have the value of aria-expanded equal to true', () => {
      const { getByTestId } = render(<MlMenuItem {...defaultProps} isLink={false} isOpen={true} showIcon={true} />)
      expect(getByTestId(menuItemTestId)).toHaveAttribute('aria-expanded', 'true')
    })
  })
  ...
  describe('when isLink is true', () => {
    it('should pass linkProps', () => {
      ...
      const { getByTestId } = render(<MlMenuItem {...defaultProps} isLink={true} linkProps={linkProps} />)
  ...
  describe('when showIcon is true', () => {
    it('should render the icon', () => {
      const { queryByTestId } = render(<MlMenuItem {...defaultProps} showIcon={true} />)
  ...
  describe('when showIcon is false', () => {
    it('should not render the icon', () => {
      const { queryByTestId } = render(<MlMenuItem {...defaultProps} showIcon={false} />)
      const iconElement = queryByTestId(menuItemIconTestId)
  ...
  describe('when className is passed', () => {
    it('should have the passed className', () => {
      ...
      const { getByTestId } = render(<MlMenuItem {...defaultProps} className={className} isLink={false} />)
      const menuItem = getByTestId(menuItemTestId)
