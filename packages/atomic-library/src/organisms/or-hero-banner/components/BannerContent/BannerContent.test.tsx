...
import { OrHeroBannerContentAlignment, OrHeroBannerVariant } from '../../or-hero-banner.types'
...
describe('BannerContent', () => {
  ...
  it('should render the component correctly with minimal props', () => {
    ...
    const { getByText, queryByTestId, queryByTitle, queryAllByRole } = render(<BannerContent {...props} />)
