...
const mountDesktopElement = (onFilterUpdate: OrFilterProps<CustomFilter>['onFilterUpdate']) => {
  return render(<OrFilter onFilterUpdate={onFilterUpdate} title="Filter by" filters={filters} />)
}
...
describe('organisms/or-filter', () => {
  it('should render correctly', async () => {
    ...
    await user.click(render.getByText(filters[0].options[0].label, { selector: 'span' }))
