...
const metricsAndImageContainerBaseClass =
  "flex flex-col items-center gap-16 xl:gap-40 3xl:gap-56";
export const metricsAndImageContainerClasses = cva(
  metricsAndImageContainerBaseClass,
  {
    variants: {
      contentAlignment: {
...
const metricContainerBaseClass =
  "flex flex-col gap-3 items-center text-center lg:items-start lg:text-left";
