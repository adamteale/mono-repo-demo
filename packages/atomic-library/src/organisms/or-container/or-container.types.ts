...
export interface OrContainerProps {
  ...
  columns: OrContainerColumn.TWO |OrContainerColumn.THREE | OrContainerColumn.FOUR
  columnsTablet: OrContainerColumn.ONE | OrContainerColumn.TWO | OrContainerColumn.THREE
