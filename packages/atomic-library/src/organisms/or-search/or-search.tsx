...
import { AtTextInput, useIsSmallDesktop } from '@components-library/common'
...
export const OrSearch = ({
  ...
  useEffect(() => {
    ...
    if (currentQuery && inputValue !== currentQuery) setInputValue(currentQuery)
    ...
    <div className="relative">
      <form onSubmit={handleOnSubmit}>
        <AtTextInput
          ...
          className={`${searchBarSize === OrSearchBarSize.LARGE ? '!h-16' : '!h-14'}`}
      ...
      <OrSearchSubmitButton onSubmit={handleOnSubmit} searchBarSize={searchBarSize} />
