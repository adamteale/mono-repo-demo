...
export const titleClasses = cva(titleBaseClass, {
  variants: {
    columns: {
      [OrFormColumn.ONE]:
        "font-bold leading-5 tracking-[0.2px] sm:text-lg sm:leading-6 sm:tracking-[0.2px]",
      [OrFormColumn.TWO]:
        "font-medium leading-6 tracking-[0.5px] sm:text-2xl sm:leading-10 sm:tracking-[0.5px]",
      [OrFormColumn.FOUR]:
        "font-medium leading-6 tracking-[0.5px] sm:text-2xl sm:leading-10 sm:tracking-[0.5px]",
    },
  },
...
const subtitleBaseClass =
  "leading-5 tracking-[0.2px] sm:leading-6 tracking-[0.2px]";
