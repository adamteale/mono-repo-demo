...
export type AtControlSize = (typeof AT_CONTROL_ARROW_SIZES)[keyof typeof AT_CONTROL_ARROW_SIZES]
...
export type AtControlIcon = (typeof AT_CONTROL_ICON)[keyof typeof AT_CONTROL_ICON]
...
export type ControlIconProps = Pick<AtControlProps, 'size' | 'icon' | 'className'> & { style?: CSSProperties }
