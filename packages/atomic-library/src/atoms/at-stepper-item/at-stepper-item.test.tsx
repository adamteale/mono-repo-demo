...
describe("atoms/at-stepper-item", () => {
  describe("when is active", () => {
    it("should render correctly", () => {
      const { getByRole, getByText } = render(
        <AtStepperItem {...defaultStepperItemProps} />
      );
      ...
      expect(stepElement.parentElement).toHaveClass(
  ...
  describe("when is disabled", () => {
    it("should render correctly", () => {
      const { getByRole, getByText } = render(
        <AtStepperItem {...defaultStepperItemProps} isActive={false} />
      );
      expect(getByRole("stepper")).toBeInTheDocument();
      ...
      expect(stepElement.parentElement).toHaveClass(
        "bg-transparent border-cta-disabled"
      );
