...
describe('atoms/at-stick-bar', () => {
  describe('when the component is created', () => {
    it('should render correctly', () => {
      const { container } = render(<AtStickBar text={<p>FREE SHIPPING ON ORDERS OVER $99</p>} />)
  ...
  describe('when a user closes the component', () => {
    it('should call onClose when stickbar is clicked', () => {
      ...
      const { getByTestId } = render(
        <AtStickBar text={<p>FREE SHIPPING ON ORDERS OVER $99</p>} onClose={onClose} hidden={false} />,
      )
