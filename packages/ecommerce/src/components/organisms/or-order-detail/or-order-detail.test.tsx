...
const defaultProps: OrOrderDetailProps = {
  title: 'Order Details',
  detailItems: [
    { title: 'Email', link: { children: 'Edit' }, details: [{ label: 'jhon*****@applydigital.com' }] },
    {
  ...
  formCheckbox: {
    type: 'checkbox',
    label: 'By placing this order, I agree with the privacy policy and terms of use.',
...
describe('organisms/or-order-detail', () => {
        ...
        detailItems={[
          {
            ...
            details: [{ label: 'Jhon Smith' }, { label: 'Visa ******4356' }, { label: 'Exp 03/2027' }],
          },
  ...
  it('renders correctly with image and submits form', async () => {
    const { getByText, queryAllByTestId, getByTestId } = render(<OrOrderDetail {...defaultProps} />)
