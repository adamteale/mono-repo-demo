...
export const useStickBar = (onCloseStickbar: Function | undefined, isStickBarHidden: boolean | undefined) => {
  ...
  return { isHidden, stickBarContainerRef, getStickBarHeight, handleCloseStickBar }
}
