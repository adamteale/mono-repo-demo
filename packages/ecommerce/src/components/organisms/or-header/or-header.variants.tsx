...
const hamburgerMenuContainerBaseClass =
  "h-screen container bg-navbar-content-primary xl:hidden";

export const hamburgerMenuContainerClasses = cva(
  hamburgerMenuContainerBaseClass,
  {
    variants: {
      isMobileMenuOpen: {
        true: "block",
...
const mobileHamburgerIconAndLogoWrapperBaseClass =
  "flex flex-row items-center xl:hidden";

export const mobileHamburgerIconAndLogoWrapperClasses = cva(
  mobileHamburgerIconAndLogoWrapperBaseClass,
  {
    variants: {
      isMobileMenuOpen: {
        // true: 'gap-3 md:gap-8',
