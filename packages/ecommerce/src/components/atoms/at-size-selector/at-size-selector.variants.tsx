...
export const sizeSelector = cva(baseClass, {
  variants: {
    state: {
      ...
      soldOut: 'bg-neutral-100 text-cta-content-disabled hover:border-cta-primary',
    },
    isSelected: {
  ...
  compoundVariants: [{ isSelected: false, state: 'soldOut', className: 'border-cta-disabled' }],
  defaultVariants: {
    state: 'available',
    isSelected: false,
  },
