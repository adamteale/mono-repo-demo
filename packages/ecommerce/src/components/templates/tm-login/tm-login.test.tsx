...
import { AtButtonProps, AtButtonVariants } from '@components-library/common/src/components/atoms'
...
describe('templates/tm-login', () => {
  ...
  it('should not render the continue as guest section', () => {
    const { queryByText, getByText } = render(
      <TmLogin formControls={formControls} formButton={formButton} handleSubmit={(state) => console.log(state)} />,
    )
